...
const user0 = new User_1.User("", []);
const user1 = new User_1.User("Zakaria", []);
const user2 = new User_1.User("Abdel Alhamid", []);
const user3 = new User_1.User("Zaki", []);
let arrayOfUsers = new Array();
arrayOfUsers.push(user0, user1, user2, user3);
(0, functions_1.checkUserAndTasks)(arrayOfUsers);
console.log("-----All users are printed-----\n");
console.log("-----Creat a to-do-list-----\n");
const todo0 = new Todo_1.Todo([user0], "App mit Typescripte", "Description....", deadLineToDo1, created_atToDo1, "Categorie 1", false);
const todo1 = new Todo_1.Todo([user0], "App mit Java Spring Boot", "Description....", deadLineToDo2, created_atToDo2, "Categorie 4", false);
const todo2 = new Todo_1.Todo([user0], "Testing the App", "Description....", deadLineToDo3, created_atToDo3, "Categorie 11", false);
let arrayOfToDo = new Array();
arrayOfToDo.push(todo0, todo1, todo2);
for (let iList = 0; iList <= 3; iList++) {
...
(0, functions_1.checkUserAndTasks)(arrayOfToDoWithUsers);
