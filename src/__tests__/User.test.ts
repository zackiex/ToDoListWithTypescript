...
describe('TodoList <-> TodoItem relationship', () => {
        test('TodoList contains TodoItem', () => {
            ...
            //THEN
            expect(todoList.todoItems).toContain(todoItem1)
        });
        test('TodoList 1:n TodoItem relationship test', () => {
            ...
            //WHEN
            const todoItem1 = new TodoItem('testTodoItem1', todoList)
            const todoItem2 = new TodoItem('testTodoItem1', todoList)
            const todoItem3 = new TodoItem('testTodoItem1', todoList)
            todoItem1.addTodoList(todoList)
        ...
        test('TodoItem belong to a TodoList', () => {
            ...
            todoItem1.addTodoList(todoList)
            //THEN
            expect(todoItem1.todoLists).toContain(todoList)
        });
        test('TodoItem belong to n TodoList', () => {
            ...
            //THEN
            expect(todoItem1.todoLists).toEqual([todoList, todoList2])
            expect(todoItem1.todoLists).toHaveLength(2)
        });
    }
);
...
describe("Delete Methods Testing", () => {
    test('Test the deleteTodoItem methode in TodoList ', () => {
        ...
        expect(todoList.todoItems).toEqual([todoItem2, todoItem3])
        expect(todoList.todoItems).toHaveLength(2)
    });
    ...
    test('Test the deleteTodoList methode in TodoItem ', () => {
        ...
        //THEN
        expect(todoItem1.todoLists).not.toContain(todoList2)
        expect(todoItem1.todoLists).toEqual([todoList, todoList3])
    });
});
